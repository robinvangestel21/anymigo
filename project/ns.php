...
<body class='white-bg' onresize='checkWidth()'>
  ...
  <!-- Colored top section -->
  <div class='fg header header-projects-ns'>
    ...
    <section class='header-main'>
      ...
      <h1>
        <?php echo $lang['ns-header-titel-desktop'];?>
      </h1>
      <h4>
  ...
  <!-- Main blocks -->
  <section class='fg project_block_1 ns' id='project_block_1'>
    <div class='vimeo-video-container' id='vimeo-video-container'>
      <iframe id='vimeo-player' class='vimeo-video'
        src="https://player.vimeo.com/video/<?php echo $lang['ns-vimeo-id']?>" frameborder="0"
        allow="autoplay; fullscreen" allowfullscreen></iframe>
      <div id='vimeo-thumb-btn' class='overlay-vimeo'>
        <img src="/static/projecten/ns/NS-Thumb–Video.png" alt="">
    ...
    <div class='block_1_divider'>
      <p>
        <?php echo $lang['ns-video-tekst'];?>
      </p>
      <div class='block_1_tagline'>
        <h5>
          <?php echo $lang['ns-tag-een'];?>
        </h5>
        <h5>
          <?php echo $lang['ns-tag-twee'];?>
        </h5>
        <h5>
          <?php echo $lang['ns-tag-drie'];?>
        </h5>
        <h5>
          <?php echo $lang['ns-tag-vier'];?>
        </h5>
      </div>
    </div>
  </section>

  <section class="fg project_block_2_ns column_block">
    <div class="column_block_left_column">
      <div class="column_block_left_column_text">
        <h1 class="column_block_title">
          <?php echo $lang['ns-blok-een-titel'];?>
        </h1>
        <p class="column_block_text">
          <?php echo $lang['ns-blok-een-tekst'];?>
        </p>
      </div>
    </div>
    <div class="column_block_right_column">
      <div class="column_block_right_column_image">
        <video id='animation1' class="column_block_image" autoplay loop muted playsinline
          poster="/static/projecten/ns/ns-1.png">
        </video>
  ...
  <section class="fg project_block_3_ns column_block">
    <div class="column_block_left_column">
      <div class="column_block_left_column_background_image">
        <img class="column_block_background_image" src="/static/projecten/ns/ns-2.png" alt="">
      </div>
    </div>
    <div class="column_block_right_column">
      <div class="column_block_right_column_text">
        <h1 class="column_block_title">
          <?php echo $lang['ns-blok-twee-titel'];?>
        </h1>
        <p class="column_block_text">
          <?php echo $lang['ns-blok-twee-tekst'];?>
        </p>
  ...
  <section class="fg project_block_4_ns row_block">
    <div class="row_block_left">
      <h1 class="row_block_title">
        <?php echo $lang['ns-blok-drie-titel'];?>
      </h1>
    </div>
    <div class="row_block_right">
      <p class="row_block_text">
        <?php echo $lang['ns-blok-drie-tekst'];?>
      </p>
    </div>
  </section>

  <section class="fg project_block_5_ns column_block">
    <div class="column_block_left_column">
      <div class="column_block_left_column_text">
        <h1 class="column_block_title">
          <?php echo $lang['ns-blok-vier-titel'];?>
        </h1>
        <p class="column_block_text">
          <?php echo $lang['ns-blok-vier-tekst'];?>
        </p>
      </div>
    </div>
    <div class="column_block_right_column">
      <div class="column_block_right_column_image">
        <video id='animation2' class="column_block_image" autoplay loop muted playsinline
          poster="/static/projecten/ns/ns-3.png">
        </video>
      </div>
    </div>
  </section>
  ...
  <section class='fg project_endblock'>
    <div class='love-container'>
      <h1 class='left'>
        <?php echo $lang['ns-klantnaam-kort'];?>
      </h1>
    ...
    <div class='next-prev-container'>
      ...
      <div class='separator'></div>
      <a class='next' href="kinsmenchristmas">
        <p class='destination'>
  ...
  if (!isIE11()) {
    ...
    animation1.src = supportsHEVCAlpha() ? '/static/projecten/ns/animations/ns-banners.mov' :
      '/static/projecten/ns/animations/ns-banners.webm';
    const animation2 = document.getElementById('animation2');
    animation2.src = supportsHEVCAlpha() ? '/static/projecten/ns/animations/ns-anymigo.mov' :
      '/static/projecten/ns/animations/ns-anymigo.webm';
  }
  </script>
</body>
