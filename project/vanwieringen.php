...
<head>
  ...
  <link rel="stylesheet" href="/style/vanwieringen.css">
...
<body class='white-bg' onresize='checkWidth()'>
  ...
  <!-- Colored top section -->
  <div class='fg header header-projects-vanwieringen'>
    <svg id='header-bg-desktop' viewBox="0 0 1483.75 833.01" preserveAspectRatio="none">
      <defs>
        <linearGradient spreadMethod="pad" id="gradient-desktop" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" style="stop-color:#EF5222;stop-opacity:1;" />
          <stop offset="100%" style="stop-color:#F7821E;stop-opacity:1;" />
        </linearGradient>
      </defs>
    ...
    <section class='header-main'>
      ...
      <h1 class='desktop'>
        <?php echo $lang['van-wieringen-header-titel-desktop'];?>
      </h1>
      <h1 class='mobile'>
        <?php echo $lang['van-wieringen-header-titel-mobile'];?>
      </h1>
      <h4>
  ...
  <!-- Main blocks -->
  <section class='fg project_block_1 vanwieringen' id='project_block_1'>
    <div class='vimeo-video-container' id='vimeo-video-container'>
      <iframe id='vimeo-player' class='vimeo-video'
        src="https://player.vimeo.com/video/<?php echo $lang['van-wieringen-vimeo-id']?>" frameborder="0"
        allow="autoplay; fullscreen" allowfullscreen></iframe>
      <div id='vimeo-thumb-btn' class='overlay-vimeo'>
        <img src="/static/projecten/vanwieringen/VanWieringen-Thumb–Video.png" alt="">
    ...
    <div class='block_1_divider'>
      <p>
        <?php echo $lang['van-wieringen-video-tekst'];?>
      </p>
      <div class='block_1_tagline'>
        <h5>
          <?php echo $lang['van-wieringen-tag-een'];?>
        </h5>
        <h5>
          <?php echo $lang['van-wieringen-tag-twee'];?>
        </h5>
        <h5>
          <?php echo $lang['van-wieringen-tag-drie'];?>
        </h5>
        <h5>
          <?php echo $lang['van-wieringen-tag-vier'];?>
        </h5>
      </div>
    </div>
  </section>

  <section class="fg project_block_2_vanwieringen column_block">
    <div class="column_block_left_column">
      <div class="column_block_left_column_image">
        <img class="column_block_image" src="/static/projecten/vanwieringen/van-wieringen-1.png" alt="">
      </div>
    </div>
    <div class="column_block_right_column">
      <div class="column_block_right_column_text">
        <h1 class="column_block_title">
          <?php echo $lang['van-wieringen-blok-een-titel'];?>
        </h1>
        <p class="column_block_text">
          <?php echo $lang['van-wieringen-blok-een-tekst'];?>
        </p>
      </div>
    </div>
  </section>

  <section class="fg project_block_3_vanwieringen row_block">
    <div class="row_block_left">
      <h1 class="row_block_title">
        1800+
      </h1>
      <p class="row_block_title">
        <?php echo $lang['van-wieringen-blok-twee-titel'];?>
      </p>
    </div>
    <div class="row_block_right">
      <p class="row_block_text">
        <?php echo $lang['van-wieringen-blok-twee-tekst'];?>
      </p>
    </div>
  </section>

  <section class="fg project_block_4_vanwieringen center_block">
    <h1 class="center_block_title">
      <?php echo $lang['van-wieringen-blok-drie-titel'];?>
    </h1>
    <p class="center_block_text">
      <?php echo $lang['van-wieringen-blok-drie-tekst'];?>
    </p>

    <video class="center_block_image" id='animation1' autoplay loop muted playsinline
      poster="/static/projecten/vanwieringen/van-wieringen-2.png">
    </video>
  </section>

  <section class="fg project_block_5_vanwieringen center_block">
    <h1 class="center_block_title">
      <?php echo $lang['van-wieringen-blok-vier-titel'];?>
    </h1>
    <p class="center_block_text">
      <?php echo $lang['van-wieringen-blok-vier-tekst'];?>
    </p>

    <video class="center_block_image desktop-img" id='animation2' autoplay loop muted playsinline
      poster="/static/projecten/vanwieringen/van-wieringen-3.png">
    </video>
    <img class="center_block_image mobile-img" src="/static/projecten/vanwieringen/van-wieringen-3-mobile.png" alt="">
  </section>

  <section class="fg project_block_6_vanwieringen column_block">

    <div class="column_block_left_column">
      <div class="column_block_left_column_text">
        <h1 class="column_block_title">
          <?php echo $lang['van-wieringen-blok-vijf-titel'];?>
        </h1>
        <p class="column_block_text">
          <?php echo $lang['van-wieringen-blok-vijf-tekst'];?>
        </p>
      </div>
    </div>
    <div class="column_block_right_column">
      <div class="column_block_right_column_background_image">
        <video id='animation3' autoplay loop muted playsinline
          poster="/static/projecten/vanwieringen/van-wieringen-4.png">
        </video>
        <img class="column_block_background_image" src="/static/projecten/vanwieringen/van-wieringen-4-bg.png" alt="">
      </div>
    </div>
  </section>
  ...
  if (!isIE11()) {
    ...
    animation1.src = supportsHEVCAlpha() ? '/static/projecten/vanwieringen/animations/vanwieringen-carousel.mov' :
      '/static/projecten/vanwieringen/animations/vanwieringen-carousel.webm';
    const animation2 = document.getElementById('animation2');
    animation2.src = supportsHEVCAlpha() ? '/static/projecten/vanwieringen/animations/vanwieringen-locatie.mov' :
      '/static/projecten/vanwieringen/animations/vanwieringen-locatie.webm';
    const animation3 = document.getElementById('animation3');
    animation3.src = supportsHEVCAlpha() ? '/static/projecten/vanwieringen/animations/vanwieringen-music.mov' :
      '/static/projecten/vanwieringen/animations/vanwieringen-music.webm';
