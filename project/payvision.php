...
<head>
  ...
  <link rel="stylesheet" href="/style/payvision.css">
...
<body class='white-bg' onresize='checkWidth()'>
  ...
  <!-- Colored top section -->
  <div class='fg header header-projects-payvision'>
    ...
    <section class='header-main'>
      ...
      <h1>
        <?php echo $lang['payvision-header-titel-desktop'];?>
      </h1>
      <h4>
  ...
  <!-- Main blocks -->
  <section class='fg project_block_1 payvision' id='project_block_1'>
    <div class='vimeo-video-container' id='vimeo-video-container'>
      <iframe id='vimeo-player' class='vimeo-video'
        src="https://player.vimeo.com/video/<?php echo $lang['payvision-vimeo-id']?>" frameborder="0"
        allow="autoplay; fullscreen" allowfullscreen></iframe>
      <div id='vimeo-thumb-btn' class='overlay-vimeo'>
        <img src="/static/projecten/payvision/Payvision-Thumb–Video.png" alt="">
    ...
    <div class='block_1_divider'>
      <p>
        <?php echo $lang['payvision-video-tekst'];?>
      </p>
      <div class='block_1_tagline'>
        <h5>
          <?php echo $lang['payvision-tag-een'];?>
        </h5>
        <h5>
          <?php echo $lang['payvision-tag-twee'];?>
        </h5>
        <h5>
          <?php echo $lang['payvision-tag-drie'];?>
        </h5>
        <h5>
          <?php echo $lang['payvision-tag-vier'];?>
        </h5>
      </div>
    </div>
  </section>

  <section class='fg project_block_2_payvision'>
    <h1>
      <?php echo $lang['payvision-blok-een-titel'];?>
    </h1>
    <p>
      <?php echo $lang['payvision-blok-een-tekst'];?>
    </p>

  </section>
  <section class='fg project_block_2_5_payvision'>
    <img src="/static/projecten/payvision/payvision-1.png" alt="">
    <video id='animation1' autoplay loop muted playsinline>

    </video>
  </section>
  <section class='fg project_block_3_payvision'>
    <h1>
      <?php echo $lang['payvision-blok-twee-titel'];?>
    </h1>
    <p>
      <?php echo $lang['payvision-blok-twee-tekst'];?>
    </p>
    <video id='animation2' autoplay loop muted playsinline poster="/static/projecten/payvision/payvision-2.png">
    </video>
  </section>

  <section class="fg project_block_4_payvision column_block">
    <div class="column_block_left_column">
      <div class="column_block_left_column_text">
        <h1 class="column_block_title">
          <?php echo $lang['payvision-blok-drie-titel'];?>
        </h1>
        <p class="column_block_text">
          <?php echo $lang['payvision-blok-drie-tekst'];?>
        </p>

      </div>
    </div>
    <div class="column_block_right_column">
      <div class="column_block_right_column_image">
        <video id='animation3' class="column_block_image" autoplay loop muted playsinline
          poster="/static/projecten/payvision/payvision-3.png">
        </video>
        <img class='mobile-image' class="column_block_image" src="/static/projecten/payvision/payvision-3-mobile.png"
          alt="">
      </div>
    </div>
  </section>

  <section class="fg project_block_5_payvision column_block">
    <div class="column_block_left_column">
      <div class="column_block_left_column_image">
        <svg id='brown-arrow' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 156.566 583.609">
          <path
            d="M719.059,411.233V236.541H604V820.15h115.06V668.767c0-30.625,16.363-60.426,31.591-87,6.126-10.69,9.915-25.458,9.915-41.77s-3.789-31.08-9.915-41.769C735.422,471.659,719.059,441.858,719.059,411.233Z"
            transform="translate(760.565 820.15) rotate(180)" fill="#212121" />
          <path d="M721.013,545.565V528.777l12,8.394Z" transform="translate(760.565 820.15) rotate(180)" fill="#fff" />
        </svg>
        <img class="column_block_image" src="/static/projecten/payvision/payvision-4.png" alt="">
    ...
    <div class="column_block_right_column">
      <div class="column_block_right_column_text">
        <h1 class="column_block_title">
          <?php echo $lang['payvision-blok-vier-titel'];?>
        </h1>
      </div>
    </div>
  </section>
  ...
  if (!isIE11()) {
    ...
    animation1.src = supportsHEVCAlpha() ? '/static/projecten/payvision/animations/payvision-anymigo.mov' :
      '/static/projecten/payvision/animations/payvision-anymigo.webm';
    const animation2 = document.getElementById('animation2');
    animation2.src = supportsHEVCAlpha() ? '/static/projecten/payvision/animations/payvision-headshots.mov' :
      '/static/projecten/payvision/animations/payvision-headshots.webm';
    const animation3 = document.getElementById('animation3');
    animation3.src = supportsHEVCAlpha() ? '/static/projecten/payvision/animations/payvision-iconen.mov' :
      '/static/projecten/payvision/animations/payvision-iconen.webm';
  }
  </script>
</body>
