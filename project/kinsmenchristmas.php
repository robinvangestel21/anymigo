...
<head>
  ...
  <link rel="stylesheet" href="/style/kinsmenchristmas.css">
...
<body class='white-bg' onresize='checkWidth()'>
  ...
  <!-- Colored top section -->
  <div class='fg header header-projects-kinsmenchristmas'>
    ...
    <section class='header-main'>
      ...
      <h1>
        <?php echo $lang['kinsmen-header-titel-desktop'];?>
      </h1>
      <h4>
        <?php echo $lang['kinsmen-optie-een'];?>
        |
        <?php echo $lang['kinsmen-optie-drie'];?>
      </h4>
    </section>
  ...
  <!-- Main blocks -->
  <section class='fg project_block_1 kinsmenchristmas' id='project_block_1'>
    <div class='vimeo-video-container' id='vimeo-video-container'>
      <iframe id='vimeo-player' class='vimeo-video'
        src="https://player.vimeo.com/video/<?php echo $lang['kinsmen-vimeo-id']?>" frameborder="0"
        allow="autoplay; fullscreen" allowfullscreen></iframe>
      <div id='vimeo-thumb-btn' class='overlay-vimeo'>
        <img src="/static/projecten/kinsmenchristmas/KinsmenChristmas-Thumb–Video.png" alt="">
    ...
    <div class='block_1_divider'>
      <p>
        <?php echo $lang['kinsmen-video-tekst'];?>
      </p>
      <div class='block_1_tagline'>
        <h5>
          <?php echo $lang['kinsmen-tag-een'];?>
        </h5>
        <h5>
          <?php echo $lang['kinsmen-tag-twee'];?>
        </h5>
        <h5>
          <?php echo $lang['kinsmen-tag-drie'];?>
        </h5>
      </div>
    </div>
  </section>

  <section class="fg project_block_2_kinsmenchristmas column_block">
    <div class="column_block_left_column">
      <div class="column_block_left_column_text">
        <h1 class="column_block_title">
          <?php echo $lang['kinsmen-blok-een-titel'];?>
        </h1>
        <p class="column_block_text">
          <?php echo $lang['kinsmen-blok-een-tekst'];?>
        </p>
      </div>
    </div>
    <div class="column_block_right_column">
      <div class="column_block_right_column_image">
        <video id='animation1' class="column_block_image" autoplay loop muted playsinline
          poster="/static/projecten/kinsmenchristmas/kerst-1.png">
        </video>
        <img class='mobile-image' class="column_block_image" src="/static/projecten/kinsmenchristmas/kerst-1-mobile.png"
          alt="">
      </div>
    </div>
  </section>

  <section class="fg project_block_3_kinsmenchristmas">
    <img src="/static/projecten/kinsmenchristmas/kerst-2.png" alt="">
    <img class='mobile-image' src="/static/projecten/kinsmenchristmas/kerst-2-mobile.png" alt="">
    <h1>
      <?php echo $lang['kinsmen-blok-twee-titel'];?>
    </h1>
    <p>
      <?php echo $lang['kinsmen-blok-twee-tekst'];?>
    </p>
  </section>

  <section class="fg project_block_4_kinsmenchristmas">
    <h1>
      <?php echo $lang['kinsmen-blok-drie-titel'];?>
    </h1>
    <p>
      <?php echo $lang['kinsmen-blok-drie-tekst'];?>
    </p>
    <video id='animation2' autoplay loop muted playsinline poster="/static/projecten/kinsmenchristmas/kerst-3.png">
    </video>
    <img class='mobile-image' src="/static/projecten/kinsmenchristmas/kerst-3-mobile.png" alt="">
  </section>

  <section class="fg project_block_5_kinsmenchristmas">
    <video id='animation3' autoplay loop muted playsinline poster="/static/projecten/kinsmenchristmas/kerst-4.png">
    </video>
    <img class='mobile-image' src="/static/projecten/kinsmenchristmas/kerst-4-mobile.png" alt="">
  </section>

  <section class='fg project_endblock'>
    <div class='love-container'>
      <h1 class='left'>
        <?php echo $lang['kinsmen-klantnaam-kort'];?>
      </h1>
  ...
  if (!isIE11()) {
    ...
    animation1.src = supportsHEVCAlpha() ?
      '/static/projecten/kinsmenchristmas/animations/kinsmenchristmas-message.mov' :
      '/static/projecten/kinsmenchristmas/animations/kinsmenchristmas-message.webm';
    const animation2 = document.getElementById('animation2');
    animation2.src = supportsHEVCAlpha() ?
      '/static/projecten/kinsmenchristmas/animations/kinsmenchristmas-rendering.mov' :
      '/static/projecten/kinsmenchristmas/animations/kinsmenchristmas-rendering.webm';
    const animation3 = document.getElementById('animation3');
    animation3.src = supportsHEVCAlpha() ? '/static/projecten/kinsmenchristmas/animations/kinsmenchristmas-vormen.mov' :
      '/static/projecten/kinsmenchristmas/animations/kinsmenchristmas-vormen.webm';
  }
  </script>
</body>
