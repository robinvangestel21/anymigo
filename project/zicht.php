...
<head>
  ...
  <link rel="stylesheet" href="/style/zicht.css">
...
<body class='white-bg' onresize='checkWidth()'>
  ...
  <!-- Colored top section -->
  <div class='fg header header-projects-zicht'>
    ...
    <section class='header-main'>
      ...
      <h1 class='desktop'>
        <?php echo $lang['zicht-header-titel-desktop'];?>
      </h1>
      <h1 class='mobile'>
        <?php echo $lang['zicht-header-titel-mobile'];?>
      </h1>
      <h4>
        ...
        |
        <?php echo $lang['zicht-optie-drie'];?>
      </h4>
    </section>
  ...
  <!-- Main blocks -->
  <section class='fg project_block_1 zicht' id='project_block_1'>
    <div class='vimeo-video-container' id='vimeo-video-container'>
      <iframe id='vimeo-player' class='vimeo-video'
        src="https://player.vimeo.com/video/<?php echo $lang['zicht-vimeo-id']?>" frameborder="0"
        allow="autoplay; fullscreen" allowfullscreen></iframe>
      <div id='vimeo-thumb-btn' class='overlay-vimeo'>
        <img src="/static/projecten/zicht/Zicht-Thumb–Video.png" alt="">
    ...
    <div class='block_1_divider'>
      <p>
        <?php echo $lang['zicht-video-tekst'];?>
      </p>
      <div class='block_1_tagline'>
        <h5>
          <?php echo $lang['zicht-tag-een'];?>
        </h5>
        <h5>
          <?php echo $lang['zicht-tag-twee'];?>
        </h5>
        <h5>
          <?php echo $lang['zicht-tag-drie'];?>
        </h5>
        <h5>
          <?php echo $lang['zicht-tag-vier'];?>
        </h5>
      </div>
    </div>
  </section>

  <section class="fg project_block_2_zicht column_block">
    <div class="column_block_left_column">
      <div class="column_block_left_column_text">
        <h1 class="column_block_title">
          <?php echo $lang['zicht-blok-een-titel'];?>
        </h1>
        <p class="column_block_text">
          <?php echo $lang['zicht-blok-een-tekst'];?>
        </p>
      </div>
    </div>
    <div class="column_block_right_column">
      <div class="column_block_right_column_background_image">
        <img class="desktop column_block_background_image" src="/static/projecten/zicht/zicht-1.png" alt="">
        <img class='mobile column_block_background_image' src="/static/projecten/zicht/zicht-1-mobile.png" alt="">
      </div>
    </div>
  </section>

  <section class="fg project_block_3_zicht row_block">
    <div class="row_block_left">
      <video id='animation1' class="row_block_image" autoplay loop muted playsinline
        poster="/static/projecten/zicht/zicht-2.png">
      </video>
    </div>
    <div class="row_block_right">

      <p class="row_block_text">
        <b class="row_block_title">
          <?php echo $lang['zicht-blok-twee-titel'];?>
        </b>
        <br>
        <?php echo $lang['zicht-blok-twee-tekst'];?>
      </p>
    </div>
  </section>

  <section class="fg project_block_4_zicht column_block_reverse_wrap">
    <div class="column_block_left_column">
      <div class="column_block_left_column_image">
        <img class="column_block_image" src="/static/projecten/zicht/zicht-3.png" alt="">
      </div>
    </div>
    <div class="column_block_right_column">
      <div class="column_block_right_column_text">
        <h1 class="column_block_title">
          <?php echo $lang['zicht-blok-drie-titel'];?>
        </h1>
        <p class="column_block_text">
          <?php echo $lang['zicht-blok-drie-tekst'];?>
        </p>
      </div>
    </div>
  </section>
  ...
  <section class='fg project_endblock'>
    ...
    <div class='next-prev-container'>
      <a class='prev' href="vanwieringen">
  ...
  if (!isIE11()) {
    ...
    animation1.src = supportsHEVCAlpha() ? '/static/projecten/zicht/animations/zicht-aspectratio.mov' :
      '/static/projecten/zicht/animations/zicht-aspectratio.webm';
