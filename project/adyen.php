...
<head>
  ...
  <link rel="stylesheet" href="/style/adyen.css">
...
<body class='white-bg' onresize='checkWidth()'>
  ...
  <!-- Colored top section -->
  <div class='fg header header-projects-adyen'>
    ...
    <section class='header-main'>
      ...
      <h1>
        <?php echo $lang['adyen-header-titel-desktop'];?>
      </h1>
      <h4>
  ...
  <!-- Main blocks -->
  <section class='fg project_block_1 adyen' id='project_block_1'>
    <div class='vimeo-video-container' id='vimeo-video-container'>
      <iframe id='vimeo-player' class='vimeo-video'
        src="https://player.vimeo.com/video/<?php echo $lang['adyen-vimeo-id']?>" frameborder="0"
        allow="autoplay; fullscreen" allowfullscreen></iframe>
      <div id='vimeo-thumb-btn' class='overlay-vimeo'>
        <img src="/static/projecten/adyen/Adyen-Thumb–Video.png" alt="">
    ...
    <div class='block_1_divider'>
      <p>
        <?php echo $lang['adyen-video-tekst'];?>
      </p>
      <div class='block_1_tagline'>
        <h5>
          <?php echo $lang['adyen-tag-een'];?>
        </h5>
        <h5>
          <?php echo $lang['adyen-tag-twee'];?>
        </h5>
        <h5>
          <?php echo $lang['adyen-tag-drie'];?>
        </h5>
      </div>
    </div>
  </section>
  ...
  <section class="fg project_block_2_adyen column_block_reverse_wrap">
    <div class="column_block_left_column">
      <div class="column_block_left_column_image">
        <video id='animation1' class="column_block_image" autoplay loop muted playsinline
          poster="/static/projecten/adyen/adyen-1.png">
        </video>
      </div>
    </div>
    <div class="column_block_right_column">
      <div class="column_block_right_column_text">
        <h1 class="column_block_title">
          <?php echo $lang['adyen-blok-een-titel'];?>
        </h1>
        <p class="column_block_text">
          <?php echo $lang['adyen-blok-een-tekst'];?>
        </p>
      </div>
    </div>
  </section>

  <section class="fg project_block_3_adyen">
    <h1>
      <?php echo $lang['adyen-blok-twee-titel'];?>
    </h1>
    <p>
      <?php echo $lang['adyen-blok-twee-tekst'];?>
    </p>
    <video id='animation2' autoplay loop muted playsinline poster="/static/projecten/adyen/adyen-2.png">
    </video>
    <img class='mobile-image' src="/static/projecten/adyen/adyen-2-mobile.png" alt="">
  </section>


  <section class="fg project_block_4_adyen column_block">
    <div class="column_block_left_column">
      <div class="column_block_left_column_image">
        <img class="column_block_image" src="/static/projecten/adyen/adyen-3.png" alt="">
      </div>
    </div>
    <div class="column_block_right_column">
      <div class="column_block_right_column_text">
        <h1 class="column_block_title">
          <?php echo $lang['adyen-blok-drie-titel'];?>
        </h1>
        <p class="column_block_text">
          <?php echo $lang['adyen-blok-drie-tekst'];?>
        </p>
      </div>
    </div>
  </section>
  ...
  <section class='fg project_endblock'>
    ...
    <div class='next-prev-container'>
      <a class='prev' href="kinsmenchristmas">
  ...
  if (!isIE11()) {
    ...
    animation1.src = supportsHEVCAlpha() ? '/static/projecten/adyen/animations/adyen-walkcycle.mov' :
      '/static/projecten/adyen/animations/adyen-walkcycle.webm';
    const animation2 = document.getElementById('animation2');
    animation2.src = supportsHEVCAlpha() ? '/static/projecten/adyen/animations/adyen-translate.mov' :
      '/static/projecten/adyen/animations/adyen-translate.webm';
  }
  </script>
</body>
