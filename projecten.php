...
<body onresize='checkWidth()'>
  ...
  <section class='fg projects_block_1' id='projects_block_1'>
    <div class='projects_block_1_1'>
      <div class='project-container'>
        ...
        <a href='project/beplayer' class='img-container'>
          <img class='image' src="static/projecten/BePlayer-Thumb.png" alt="Beplayer thumbnail">
          <div class='overlay'></div>
        </a>
        <div class='project-button' id='project-button-1'>
    ...
    <div class='projects_block_1_2'>
      <div class='project-container'>
        ...
        <a href='project/vanwieringen' class='img-container'>
          <img class='image' src="static/projecten/VanWieringen-Thumb.png" alt="VanWieringen thumbnail">
          <div class='overlay'></div>
        </a>
        <div class='project-button' id='project-button-2'>
  ...
  <!-- Colored top section -->
  <div class='fg header'>
    <svg id='header-bg-desktop' class='header-bg-desktop-projects' viewBox="0 0 1483.75 833.01"
    ...
    <svg id='header-bg-mobile' class='header-bg-mobile-projects' viewBox="0 0 579.86 873.43" preserveAspectRatio="none">
      <defs>
    ...
    <section class='header-main' id='header-main-projects'>
      <h1>
        <?php echo $lang['projecten-header-titel'];?>
      </h1>
    </section>
  ...
  <section class='fg projects_block_2' id='projects_block_2'>
    <div class='projects_block_2_1'>
      <div class='project-container'>
        <h1 class='client'>
        ...
        <a href='project/zicht' class='img-container'>
          <img class='image' src="static/projecten/Zicht-Thumb.png" alt="Zicht thumbnail">
          <div class='overlay'></div>
        </a>
        <div class='project-button' id='project-button-3'>
          <a href='project/zicht'>
            <?php echo $lang['bekijk-project'];?>
            <svg class='project-arrow desktop' viewBox="0 0 20.327 12.822">
              <g transform="translate(1 1.411)">
                <line x2="17.796" transform="translate(0 5)" fill="none" stroke="#6734b7" stroke-linecap="round"
                  stroke-miterlimit="10" stroke-width="2" />
                <path d="M-2410.074,744.258l4.364,5-4.364,5" transform="translate(2423.71 -744.258)" fill="none"
            ...
            <svg class='project-arrow mobile' viewBox="0 0 20.327 12.822">
              <g transform="translate(1 1.411)">
                <line x2="17.796" transform="translate(0 5)" fill="none" stroke="#ffcd55" stroke-linecap="round"
                  stroke-miterlimit="10" stroke-width="2" />
                <path d="M-2410.074,744.258l4.364,5-4.364,5" transform="translate(2423.71 -744.258)" fill="none"
                  stroke="#ffcd55" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" />
              </g>
            </svg>
          </a>
        </div>
    ...
    <div class='projects_block_2_2'>
      <div class='project-container'>
        ...
        <a href='project/payvision' class='img-container'>
          <img class='image' src="static/projecten/Payvision-Thumb.png" alt="Payvision thumbnail">
          <div class='overlay'></div>
        </a>
        <div class='project-button' id='project-button-4'>
  ...
  <section class='fg projects_block_3' id='projects_block_3'>
    <div class='projects_block_3_1'>
      <div class='project-container'>
        <h1 class='client'>
        ...
        <a href='project/ns' class='img-container'>
          <img class='image' src="static/projecten/NS-Thumb.png" alt="NS thumbnail">
          <div class='overlay'></div>
        </a>
        <div class='project-button' id='project-button-5'>
          <a href='project/ns'>
            <?php echo $lang['bekijk-project'];?>
            <svg class='project-arrow' viewBox="0 0 20.327 12.822">
              <g transform="translate(1 1.411)">
    ...
    <div class='projects_block_3_2'>
      <div class='project-container'>
        ...
        <a href='project/kinsmenchristmas' class='img-container'>
          <img class='image' src="static/projecten/KinsmenChristmas-Thumb.png" alt="Kinsmen Christmas thumbnail">
          <div class='overlay'></div>
        </a>
        <div class='project-button' id='project-button-6'>
  ...
  <section class='fg projects_block_4' id='projects_block_4'>
    <div class='projects_block_4_1'>
      <div class='project-container'>
        <h1 class='client'>
        ...
        <a href='project/adyen' class='img-container'>
          <img class='image' src="static/projecten/Adyen-Thumb.png" alt="Adyen thumbnail">
          <div class='overlay'></div>
        </a>
        <div class='project-button' id='project-button-7'>
    ...
    <div class='projects_block_4_2'>
      <!-- <div class='project-container'>
        ...
        <div class='project-button' id='project-button-8'>
          <a href='project/adyen'>
            <?php echo $lang['bekijk-project'];?>
            <svg class='project-arrow' viewBox="0 0 20.327 12.822">
              <g transform="translate(1 1.411)">
