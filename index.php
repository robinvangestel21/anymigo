...
<body onresize='checkWidth()'>
  ...
  <div class='fg header'>
    ...
    <section class='header-main' id='header-main-index'>
      <div class='index-column'>
        <h1>
          <?php echo $lang['home-header-titel'];?>
        </h1>
        <p>
          <?php echo $lang['home-header-tekst'];?>
        </p>
        <button id='demo-btn' onclick="location.href='/mogelijkheden'">
          <?php echo $lang['home-header-knop'];?>
  ...
  <!-- Main blocks -->
  <section class='fg index_block_1' id='index_block_1'>
    <h1>
      <?php echo $lang['home-blok-een-titel'];?>
    </h1>
    <p>
      <?php echo $lang['home-blok-een-tekst'];?>
    </p>
  </section>

  <section class='fg index_block_2' id='index_block_2'>
    <section class='index_block_2_1'>
      <img src="static/home/dashboard.png" alt="">
    </section>
    <section class='index_block_2_2'>
      <h1>
        <?php echo $lang['home-blok-twee-titel'];?>
      </h1>
      <p class='desktop'>
        <?php echo $lang['home-blok-twee-desktop-tekst-een'];?>
      </p>
      <p class='desktop'>
        <?php echo $lang['home-blok-twee-desktop-tekst-twee'];?>
      </p>
      <p class='desktop'>
        <?php echo $lang['home-blok-twee-desktop-tekst-drie'];?>
      </p>
      <p class='mobile'>
        <?php echo $lang['home-blok-twee-mobile-tekst'];?>
      </p>
      <button>
        <a href="mogelijkheden">
          <?php echo $lang['home-blok-twee-knop'];?>
          <svg class='project-arrow' viewBox="0 0 20.327 12.822">
  ...
  <section class='fg index_block_3' id='index_block_3'>
    <h1>
      <?php echo $lang['home-blok-drie-titel'];?>
    </h1>
    <p>
      <?php echo $lang['home-blok-drie-tekst'];?>
    </p>
  </section>

  <section class='fg index_block_4' id='index_block_4'>
    <div id="container">
      <div class="slides">
        ...
        <button onclick="location.href='/project/kinsmenchristmas'" class='slide slide6'>
          <div class='background'>
            <h1>
              <?php echo $lang['kinsmen-projectnaam'];?>
            </h1>
            <h3>
  ...
  <section class='fg index_block_5' id='index_block_5'>
