...
<body onresize='checkWidth()'>
  ...
  <div class='background-nav' id='hb'>
    <nav>
      ...
      <a class='active' href="/mogelijkheden">
  ...
  <section class='fg about_block_1' id='about_block_1'>
    <div class='c-container'>
      <div class='c1'>
        <img src="/static/about/voor-wie-is-anymigo.png" alt="">
      </div>
      <div class="c2">
        <h1>
          <?php echo $lang['mogelijkheden-blok-een-titel'];?>
        </h1>
        <p>
          <?php echo $lang['mogelijkheden-blok-een-tekst'];?>
        </p>
      </div>
    </div>
  </section>
  ...
  <div class='fg header'>
    ...
    <section class='header-main' id='header-main-about'>
      <div class='about-column'>
        <h1>
          <?php echo $lang['mogelijkheden-header-titel'];?>
        </h1>
        <p>
          <?php echo $lang['mogelijkheden-header-tekst'];?>
        </p>
        <button id='demo-btn' onclick="location.href='/projecten'">
          <?php echo $lang['mogelijkheden-header-knop'];?>
          <svg id="arrow-demo" data-name="arrow-demo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.28 12.48">
            <defs>
              <style>

              </style>
            </defs>
            <path class="arrow-demo-1"
              d="M971.78,539.42l-5.08-5.08a1.16,1.16,0,0,0-1.65,1.64l3.1,3.09H950a1.17,1.17,0,1,0,0,2.33h18.15l-3.1,3.09a1.18,1.18,0,0,0,0,1.65,1.17,1.17,0,0,0,1.65,0l5.08-5.08a1.15,1.15,0,0,0,.34-.82A1.13,1.13,0,0,0,971.78,539.42Z"
              transform="translate(-948.83 -534)" />
          </svg>
        </button>
      ...
      <div class='about-column-center'>
        <video id='headerAnimation' autoplay loop muted playsinline poster="/static/home/anymigo_homepage_banner.png">
        </video>
      </div>
    </section>
  ...
  <!-- Main blocks -->
  <section class='fg about_block_2'>
    <div class='container'>
      <div class="c1">
        <h1>
          <?php echo $lang['mogelijkheden-blok-twee-titel'];?>
        </h1>
        <a href="projecten">
      ...
      <div class="c2">
        <p>
          <?php echo $lang['mogelijkheden-blok-twee-tekst'];?>
        </p>
        <a href="projecten">Bekijk de projecten
          <svg viewBox="0 0 20.327 12.822">
            <line x2="17.796" transform="translate(1 6.411)" fill="none" stroke="#6734b7" stroke-linecap="round"
              stroke-miterlimit="10" stroke-width="2" />
            <path d="M-2410.074,744.258l4.364,5-4.364,5" transform="translate(2424.71 -742.847)" fill="none"
  ...
  <section class='fg about_block_2_5'>
    <img src="static/about/whatIsAnymigo.png" alt="">
  </section>
  <section class='fg about_block_3'>
    <h1>
      <?php echo $lang['mogelijkheden-blok-drie-titel'];?>
    </h1>
    <!--<p>Bij Anymigo snappen we dat jij altijd en overal on brand wilt zijn. En weten als geen ander dat dit minder eenvoudig is dan het lijkt. Want wat jij bedenkt en ontwikkelt, krijgt along the way vaak onbedoeld een andere uitwerking.</p>-->
    <div id="anymigocontainer">
      <div class="anymigoslides">
        <div class='anymigoslide anymigoslide1' id='anymigoslide-1'>
          <div class='background'>
            <h1>01</h1>
            <div class='hl'></div>
            <p>
              <?php echo $lang['mogelijkheden-blok-drie-kaart-een'];?>
            </p>
          </div>
        </div>
        <div class='anymigoslide anymigoslide2'>
          <div class='background'>
            <h1>02</h1>
            <div class='hl'></div>
            <p>
              <?php echo $lang['mogelijkheden-blok-drie-kaart-twee'];?>
            </p>
          </div>
        </div>
        <div class='anymigoslide anymigoslide3'>
          <div class='background'>
            <h1>03</h1>
            <div class='hl'></div>
            <p>
              <?php echo $lang['mogelijkheden-blok-drie-kaart-drie'];?>
            </p>
          </div>
        </div>
        <div class='anymigoslide anymigoslide4'>
          <div class='background'>
            <h1>04</h1>
            <div class='hl'></div>
            <p>
              <?php echo $lang['mogelijkheden-blok-drie-kaart-vier'];?>
            </p>
          </div>
        </div>
        <div class='anymigoslide anymigoslide5'>
          <div class='background'>
            <h1>05</h1>
            <div class='hl'></div>
            <p>
              <?php echo $lang['mogelijkheden-blok-drie-kaart-vijf'];?>
            </p>
          </div>
        </div>
        <div class='anymigoslide anymigoslide6'>
          <div class='background'>
            <h1>06</h1>
            <div class='hl'></div>
            <p>
              <?php echo $lang['mogelijkheden-blok-drie-kaart-zes'];?>
            </p>
          </div>
        </div>
        <div class='anymigoslide anymigoslide7'>
          <div class='background'>
            <h1>07</h1>
            <div class='hl'></div>
            <p>
              <?php echo $lang['mogelijkheden-blok-drie-kaart-zeven'];?>
            </p>
          </div>
        </div>
        <div class='anymigoslide anymigoslide8'>
          <div class='background'>
            <h1>08</h1>
            <div class='hl'></div>
            <p>
              <?php echo $lang['mogelijkheden-blok-drie-kaart-acht'];?>
            </p>
          </div>
        </div>
        <div class='anymigoslide anymigoslide9'>
          <div class='background'>
            <h1>09</h1>
            <div class='hl'></div>
            <p>
              <?php echo $lang['mogelijkheden-blok-drie-kaart-negen'];?>
            </p>
          </div>
        </div>
      </div>
    ...
    <button id="anymigoprev-btn" class='hover'>
      <svg viewBox="0 0 22 12.828">
        <g transform="translate(24.892 12.348) rotate(180)">
          <line id='anymigoarrow-prev-line' class='arrow-prev' x2="20" transform="translate(3.892 5.973)" fill="none"
            stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
          <path id='anymigoarrow-prev-path' class='arrow-prev' d="M1725.374,87.361l5,5-5,5"
            transform="translate(-1706.481 -86.427)" fill="none" stroke-linecap="round" stroke-linejoin="round"
            stroke-width="2" />
        </g>
      </svg>
    </button>
    <button id="anymigonext-btn" class='hover'>
      <svg viewBox="0 0 22 12.828">
        <g transform="translate(24.892 12.348) rotate(180)">
          <line id='anymigoarrow-next-line' class='arrow-next' x2="20" transform="translate(3.892 5.973)" fill="none"
            stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
          <path id='anymigoarrow-next-path' class='arrow-next' d="M1725.374,87.361l5,5-5,5"
            transform="translate(-1706.481 -86.427)" fill="none" stroke-linecap="round" stroke-linejoin="round"
            stroke-width="2" />
        </g>
      </svg>
  ...
  <section class='fg about_block_4'>
    <!--Slider-->

  </section>
  <section class='fg about_block_5'>
    <!--Team-->
    <div class="container">
      <div class="c1">
        <h1>
          <?php echo $lang['mogelijkheden-blok-vier-titel'];?>
        </h1>
        <h4>
          <?php echo $lang['mogelijkheden-blok-vier-subtitel-een'];?>
        </h4>
        <p>
          <?php echo $lang['mogelijkheden-blok-vier-subtekst-een'];?>
        </p>
        <h4>
          <?php echo $lang['mogelijkheden-blok-vier-subtitel-twee'];?>
        </h4>
        <p>
          <?php echo $lang['mogelijkheden-blok-vier-subtekst-twee'];?>
        </p>
        <h4>
          <?php echo $lang['mogelijkheden-blok-vier-subtitel-drie'];?>
        </h4>
        <p>
          <?php echo $lang['mogelijkheden-blok-vier-subtekst-drie'];?>
        </p>
      </div>
      <div class="c2">
        <img src="static/about/team.png" alt="">
      </div>
    </div>
  </section>

  <section class='fg about_block_6'>
    <h1>
      <?php echo $lang['mogelijkheden-blok-vijf-titel'];?>
    </h1>
    <p>
      <?php echo $lang['mogelijkheden-blok-vijf-tekst'];?>
    </p>
  </section>
  <section class='fg about_block_7'>
    <div id="container">
      <div class="slides">
        <button onclick="location.href='/project/beplayer'" class='slide slide1' id='slide-1'>
          <div class='background'>
            <h1>
            ...
            <a href="/project/beplayer">
              <?php echo $lang['bekijk-project'];?>
              <svg viewBox="0 0 20.327 12.822">
                <g transform="translate(1 1.411)">
                  <line x2="17.796" transform="translate(0 5)" fill="none" stroke="#fffcf1" stroke-linecap="round"
                    stroke-miterlimit="10" stroke-width="2" />
                  <path d="M-2410.074,744.258l4.364,5-4.364,5" transform="translate(2423.71 -744.258)" fill="none"
                    stroke="#fffcf1" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" />
                </g>
              </svg>
            </a>
          </div>
        </button>
        <button onclick="location.href='/project/vanwieringen'" class='slide slide2' id='slide-1'>
          <div class='background'>
            <h1>
              <?php echo $lang['van-wieringen-klantnaam'];?>
            </h1>
            <h3>
              <?php echo $lang['van-wieringen-optie-een'];?>
              |
              <?php echo $lang['van-wieringen-optie-twee'];?>
            </h3>
            <a href="/project/vanwieringen">
              <?php echo $lang['bekijk-project'];?>
              <svg viewBox="0 0 20.327 12.822">
                <g transform="translate(1 1.411)">
                  <line x2="17.796" transform="translate(0 5)" fill="none" stroke="#fffcf1" stroke-linecap="round"
        ...
        <button onclick="location.href='/project/zicht'" class='slide slide3'>
          <div class='background'>
            <h1>
              <?php echo $lang['zicht-klantnaam'];?>
            </h1>
            <h3>
              <?php echo $lang['zicht-optie-een'];?>
              |
              <?php echo $lang['zicht-optie-twee'];?>
            </h3>
            <a href="/project/zicht">
              <?php echo $lang['bekijk-project'];?>
              <svg viewBox="0 0 20.327 12.822">
                <g transform="translate(1 1.411)">
                  <line x2="17.796" transform="translate(0 5)" fill="none" stroke="#fffcf1" stroke-linecap="round"
        ...
        <button onclick="location.href='/project/payvision'" class='slide slide4'>
          <div class='background'>
            <h1>
              <?php echo $lang['payvision-klantnaam'];?>
            </h1>
            <h3>
              <?php echo $lang['payvision-optie-een'];?>
              |
              <?php echo $lang['payvision-optie-twee'];?>
            </h3>
            <a href="/project/payvision">
              <?php echo $lang['bekijk-project'];?>
              <svg viewBox="0 0 20.327 12.822">
                <g transform="translate(1 1.411)">
                  <line x2="17.796" transform="translate(0 5)" fill="none" stroke="#fffcf1" stroke-linecap="round"
        ...
        <button onclick="location.href='/project/ns'" class='slide slide5'>
          <div class='background'>
            <h1>
              <?php echo $lang['ns-klantnaam'];?>
            </h1>
            <h3>
              <?php echo $lang['ns-optie-een'];?>
              |
              <?php echo $lang['ns-optie-twee'];?>
            </h3>
            <a href="/project/ns">
              <?php echo $lang['bekijk-project'];?>
              <svg viewBox="0 0 20.327 12.822">
        ...
        <button onclick="location.href='/project/kinsmenchristmas'" class='slide slide6'>
          <div class='background'>
            <h1>
              <?php echo $lang['kinsmen-klantnaam'];?>
            </h1>
            <h3>
              <?php echo $lang['kinsmen-optie-een'];?>
              |
              <?php echo $lang['kinsmen-optie-twee'];?>
            </h3>
            <a href="/project/kinsmenchristmas">
              <?php echo $lang['bekijk-project'];?>
              <svg viewBox="0 0 20.327 12.822">
                <g transform="translate(1 1.411)">
                  <line x2="17.796" transform="translate(0 5)" fill="none" stroke="#fffcf1" stroke-linecap="round"
        ...
        <button onclick="location.href='/project/adyen'" class='slide slide7'>
          <div class='background'>
            <h1>
              <?php echo $lang['adyen-klantnaam'];?>
            </h1>
            <h3>
              <?php echo $lang['adyen-optie-een'];?>
              |
              <?php echo $lang['adyen-optie-twee'];?>
            </h3>
            <a href="/project/adyen">
              <?php echo $lang['bekijk-project'];?>
              <svg viewBox="0 0 20.327 12.822">
                <g transform="translate(1 1.411)">
                  <line x2="17.796" transform="translate(0 5)" fill="none" stroke="#fffcf1" stroke-linecap="round"
    ...
    <button id="prev-btn" class='hover'>
      <svg viewBox="0 0 22 12.828">
        <g transform="translate(24.892 12.348) rotate(180)">
          <line id='arrow-prev-line' class='arrow-prev' x2="20" transform="translate(3.892 5.973)" fill="none"
            stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
          <path id='arrow-prev-path' class='arrow-prev' d="M1725.374,87.361l5,5-5,5"
            transform="translate(-1706.481 -86.427)" fill="none" stroke-linecap="round" stroke-linejoin="round"
            stroke-width="2" />
        </g>
      </svg>
    ...
    <button id="next-btn" class='hover'>
      <svg viewBox="0 0 22 12.828">
        <g transform="translate(24.892 12.348) rotate(180)">
          <line id='arrow-next-line' class='arrow-next' x2="20" transform="translate(3.892 5.973)" fill="none"
            stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
          <path id='arrow-next-path' class='arrow-next' d="M1725.374,87.361l5,5-5,5"
            transform="translate(-1706.481 -86.427)" fill="none" stroke-linecap="round" stroke-linejoin="round"
            stroke-width="2" />
        </g>
      </svg>
  ...
  <section class='fg about_block_8'>
    <a id='project-link' href="projecten">
      <?php echo $lang['bekijk-alle-projecten'];?>
      <svg viewBox="0 0 20.327 12.822">
        <g transform="translate(1 1.411)">
  ...
  if (!isIE11()) {
    ...
    headerAnimation.src = supportsHEVCAlpha() ? 'static/home/anymigo_homepage_banner.mov' :
      'static/home/anymigo_homepage_banner.webm';
